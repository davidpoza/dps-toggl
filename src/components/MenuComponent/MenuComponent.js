            ...
            <div className="d-flex flex-column justify-content-between h-100">
                <div>
                    ...
                    <ul className = {"fa-ul "+styles.ul}>
                        ...
                        <li className={styles.li}><span className = "fa-li"><i className="fas fa-folder-open"></i></span><span className={styles.item_text}><Link to="/projects">Projects</Link></span></li>
